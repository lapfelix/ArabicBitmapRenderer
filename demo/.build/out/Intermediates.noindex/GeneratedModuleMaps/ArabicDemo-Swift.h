...
#ifndef ARABICDEMO_SWIFT_H
#define ARABICDEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ArabicDemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC10ArabicDemo11AppDelegate")
...
@class NSCoder;
SWIFT_CLASS("_TtC10ArabicDemo10PanelsView")
@interface PanelsView : NSView
